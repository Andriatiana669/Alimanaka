<template>
  <div class="events-container">
    ...
    <div class="page-header">
      ...
      <div class="header-actions">
        ...
        <div class="view-toggle">
          ...
          <button 
            class="view-btn" 
            :class="{ active: mainView === 'timeline' }"
          ...
          <button 
            class="view-btn" 
            :class="{ active: mainView === 'demandes' }"
            @click="mainView = 'demandes'"
          >
    ...
    <!-- Filtres (uniquement pour les vues calendrier/timeline) -->
    <div v-if="mainView !== 'demandes'" class="filters-section">
      <!-- Filtre par type -->
    ...
    <!-- Résumé (uniquement pour les vues calendrier/timeline) -->
    <div v-if="mainView !== 'demandes'" class="stats-summary">
      <div class="stat-card">
    ...
    <!-- VUE DEMANDES -->
    <div v-if="mainView === 'demandes'" class="demandes-view">
      <DemandesList />
    </div>

    <!-- VUE CALENDRIER -->
    <div v-if="mainView === 'calendar'" class="calendar-view">
      <Calendar
    ...
    <!-- VUE TIMELINE -->
    <div v-if="mainView === 'timeline'" class="timeline-view">
...
import DemandesList from '@/components/events/DemandesList.vue'
...
// Vue principale (ajout de 'demandes')
const mainView = ref<'calendar' | 'timeline' | 'demandes'>('calendar')
