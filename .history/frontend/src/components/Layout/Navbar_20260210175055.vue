...
.navbar {
  ...
  max-width: none;
  margin-left: calc(-1 * var(--sidebar-width, 250px));  /* ← décale vers la gauche */
  margin-right: -9999px;      /* sécurité contre overflow */
  left: var(--sidebar-width, 250px);   /* ou left: 250px; */
  right: 0;
  box-sizing: border-box;
  position: sticky;           /* ou fixed selon ton besoin */
  top: 0;
  z-index: 90;
}
