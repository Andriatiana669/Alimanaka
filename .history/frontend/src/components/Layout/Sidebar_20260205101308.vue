<template>
  <aside class="sidebar" :class="{ collapsed: isCollapsed }">
    <div class="sidebar-header">
      ...
      <!-- <img v-if="!isCollapsed" src="@/assets/Logo_lalamby.svg" alt="Logo Lalamby" class="sidebar-logo" /> -->
      <div class="sidebar-logos" v-if="!isCollapsed">
        <img src="@/assets/Logo_lalamby_1.svg" alt="Logo Lalamby" class="sidebar-logo left-logo" />
        <img src="@/assets/Logo_lalamby_2.svg" alt="Autre Logo" class="sidebar-logo right-logo" />
      </div>
    ...
    <nav class="sidebar-nav">
      ...
      <!-- <router-link v-if="authStore.user?.is_staff" to="/utilisateurs" class="nav-item" active-class="active">
        <span class="icon"><i class="bi bi-person"></i></span>
        <span class="label">Utilisateurs</span>
      </router-link> -->
      
      <router-link to="/utilisateurs" class="nav-item" active-class="active">
        <span class="icon"><i class="bi bi-person"></i></span>
        <span class="label">Utilisateurs</span>
      </router-link>
