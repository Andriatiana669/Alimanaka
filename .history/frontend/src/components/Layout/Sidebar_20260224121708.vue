<template>
  <aside class="sidebar" :class="{ collapsed: isCollapsed }">
    ...
    <nav class="sidebar-nav">
      ...
      <!-- Pôles - condition d'affichage basée sur le rôle -->
      <router-link 
        v-if="canAccessPoles" 
        to="/poles" 
        class="nav-item" 
      ...
      <!-- Événements -->
      <router-link v-if="showEvents" to="/events" class="nav-item" active-class="active">
