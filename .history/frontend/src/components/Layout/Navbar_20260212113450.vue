...
// Utilise storeToRefs pour réactivité
...
// Computed - utilisent currentUser (qui vient du store, donc réactif)
const userFullName = computed(() => {
  if (!currentUser.value) return 'Utilisateur'
  // Priorité au display_name qui est mis à jour par le profil
...
const userInitials = computed(() => {
  ...
  // Utilise display_name ou pseudo en priorité
...
// Lifecycle - plus besoin de fetchCurrentUser ici, le router le fait déjà
onMounted(() => {
