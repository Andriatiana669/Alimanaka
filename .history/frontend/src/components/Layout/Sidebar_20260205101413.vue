  ...
  <aside class="sidebar" :class="{ collapsed: isCollapsed }">
    <div class="sidebar-header">
      ...
      <div class="sidebar-logos" v-if="!isCollapsed">
        <img src="@/../public/logo_gauche.svg" alt="Logo Lalamby" class="sidebar-logo left-logo" />
        <img src="@/../public/logo_droite.svg" alt="Autre Logo" class="sidebar-logo right-logo" />
      </div>
