...
const loadMembres = async () => {
  ...
  try {
    ...
    membres.value = [
      { id: 1, username: 'pr00552', first_name: 'Franckia', last_name: 'Saviola', pseudo: 'Franck' },
      { id: 2, username: 'pr00123', first_name: 'Jean', last_name: 'Dupont', pseudo: 'JD' },
      { id: 3, username: 'pr00456', first_name: 'Marie', last_name: 'Martin', pseudo: null }
    ]
  } catch (error) {
...
// Nettoyer le localStorage quand le composant est détruit (optionnel)
// import { onUnmounted } from 'vue'
// onUnmounted(() => {
//   const savedState = localStorage.getItem(STORAGE_KEY)
//   if (savedState) {
//     const state = JSON.parse(savedState)
//     delete state[props.equipe.id]
//     localStorage.setItem(STORAGE_KEY, JSON.stringify(state))
//   }
// })
</script>
