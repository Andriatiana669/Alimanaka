...
const props = defineProps<{
  ...
  placeholder?: string
  disabled?: boolean
  filtrePole?: number | null  // Filtrer par pôle
}>()
...
// Filtrer les équipes par pôle si spécifié
...
// Grouper par pôle pour l'affichage
...
// Réinitialiser la sélection si l'équipe n'est plus dans le pôle filtré
