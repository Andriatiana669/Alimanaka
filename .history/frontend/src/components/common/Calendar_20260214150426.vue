          ...
          <div class="days-grid">
            ...
            >
              ...
              <div class="events-container">
                <div v-for="event in getEventsForDay(day.date)" class="calendar-event" :key="event.id" :class="{ 'all-day': event.allDay }" :style="getEventStyle(event)" @click="$emit('event-click', event)" >
