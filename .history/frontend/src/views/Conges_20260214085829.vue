<template>
  ...
  <div class="filter-tabs">
    <label>Pôle</label>
    <select v-model="filters.pole" @change="onFilterChange" class="filter-button">
  ...
  <div class="filter-tabs">
    <label>Équipe</label>
    <select v-model="filters.equipe" @change="onFilterChange" :disabled="!filters.pole" class="filter-button">
  ...
  <div class="filter-tabs">
    <button
      :class="{ active: statusFilter === 'tous', 'filter-button' : true }"
      @click="setStatusFilter('tous')"
    >
      Tous
    </button>
    <button
      :class="{ active: statusFilter === 'approuve', 'filter-button' : true }"
      @click="setStatusFilter('approuve')"
    >
      Approuvés
    </button>
    <button
      :class="{ active: statusFilter === 'en_attente', 'filter-button' : true }"
