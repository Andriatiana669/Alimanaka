        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <textarea 
              ...
              rows="2" 
              class="form-textarea"
              placeholder="N'oublie pas d'apporter ton pièce justificatif (PJ) au près du RH"
            ></textarea>
...
const form = ref({
  ...
  heure_fin: '',
  motif: '',
  avertissement: "N'oublie pas d'apporter ton pièce justificatif (PJ) au près du RH"
})
