  ...
  <Teleport to="body">
    <div v-if="showRetourModal" class="modal-overlay" @click.self="closeRetourModal">
        ...
        <div class="modal-body">
            ...
            <div v-if="retourForm.heure_arrivee_reelle" class="preview-box" :class="minutesDepassement > 0 ? 'warning-box' : 'info-box'">
              ...
              <div v-else class="calcul-detail">
                <p><strong>✅ Retour dans les temps</strong></p>
                <p>Calcul des heures à rattraper :</p>
                <ul class="calcul-list">
                  <li>Durée d'absence : {{ differenceInMinutes(
                    new Date(selectedPermission?.date + 'T' + retourForm.heure_arrivee_reelle),
                    new Date(selectedPermission?.date + 'T' + selectedPermission?.heure_depart)
                  ) }} minutes</li>
                  <!-- <li>Forfait minimum : 30 minutes</li> -->
                  <li class="calcul-total">Total à rattraper : <strong>{{ heuresARattraperRetour }}h</strong></li>
                </ul>
              </div>
              
              <p class="info-text">
                <i class="bi bi-info-circle"></i>
                {{ minutesDepassement > 0 
                  ? 'Vous pourrez choisir entre rattrapage ou transformation en congé.' 
                  : 'Rattrapage obligatoire même si retour dans les temps.' 
                }}
              </p>
            </div>
