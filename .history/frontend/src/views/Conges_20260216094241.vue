  ...
  <div v-if="congesStore.isManagerOrAdmin || congesStore.isSuperAdmin" class="filters-bar">
    ...
    <div class="filter-tabs">
      <div class="custom-select">
        <button
          class="select-button"
          :class="{ active: filters.equipe !== null, disabled: !filters.pole && !congesStore.isSuperAdmin }"
          @click="toggleEquipeDropdown"
          :disabled="!filters.pole && !congesStore.isSuperAdmin"
        >
          {{ filters.equipe ? selectedEquipeName : 'Toutes les équipes' }}
        </button>
        <div v-if="showEquipeDropdown && (filters.pole || congesStore.isSuperAdmin)" class="select-dropdown">
          <div
            class="select-option"
