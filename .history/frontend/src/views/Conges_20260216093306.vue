...
const refreshData = async () => {
  ...
  // CORRECTION : Construire les params avec le statut
  const params: any = { 
    annee: getYear(new Date()),
    statut: statusFilter.value === 'tous' ? undefined : statusFilter.value  // ← AJOUTÉ
  }
  ...
  await Promise.all([
    congesStore.fetchCalendrier(params),  // ← Passe les params avec statut
