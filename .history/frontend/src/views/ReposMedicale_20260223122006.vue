  ...
  <div class="page-header">
    <div class="header-left">
      ...
      <div v-if="authStore.user" class="repos-badge">
        <span class="heures-total">{{ (totalHeuresRepos || 0).toFixed(2) }}h total</span>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <textarea 
              ...
              rows="2" 
              class="form-textarea"
              placeholder="N'oublie pas d'apporter votre pièce justificatif (PJ) au près du RH"
            ></textarea>
...
const form = ref({
  ...
  heure_fin: '',
  motif: '',
  avertissement: "N'oublie pas d'apporter votre pièce justificatif (PJ) au près du RH"
})
