        ...
        <div v-else class="profile-card">
          ...
          <div class="profile-header">
            ...
            <div class="profile-info">
              <h2>{{ currentUser ? currentUser.display_name : '' }}</h2>
              <p class="user-role">
                <i class="bi bi-person-badge"></i>
                {{ currentUser ? getUserRole(currentUser) : 'Non défini' }}
              </p>
              <p class="join-date">
                <i class="bi bi-calendar-plus"></i>
                Membre depuis {{ currentUser ? formatDate(currentUser.date_joined) : '' }}
              </p>
            </div>
          </div>
            ...
            <div class="form-section">
              ...
              <div class="form-group">
                ...
                <div class="current-value">
                  {{ currentUser ? currentUser.pseudo || 'Aucun pseudo défini' : 'Aucun pseudo défini' }}
                </div>
              </div>
              <div class="form-group">
