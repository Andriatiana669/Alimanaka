<template>
  <div class="equipes-page">
    ...
    <div class="page-header">
      ...
      <span class="role-badge-header" :class="getRoleClass(authUser)">
        {{ getRoleLabel(authUser) }}
      </span>
      <button v-if="canManageEquipes(authUser)" class="btn-primary" @click="openCreateModal">
    ...
    <div v-if="selectedEquipe" class="equipe-details">
      <div class="details-header">
        ...
        <button 
          v-if="canManageEquipes(authUser)" 
          class="btn-icon edit" 
          @click="openEditModal(selectedEquipe)"
        >
          <i class="bi bi-pencil"></i> 
          {{ canEditEquipeDetails(authUser) ? 'Modifier' : 'Gérer membres' }}
        </button>
      </div>
        ...
        <table v-else class="membres-table">
          <thead>
            <tr>
              ...
              <th>Prénom</th>
              <th>Pseudo</th>
              <th v-if="canManageEquipes(authUser)">Actions</th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="membre in membres" :key="membre.id">
              ...
              <td v-if="canManageEquipes(authUser)">
                <button 
    ...
    <div v-if="showCreateModal && canEditEquipeDetails(authUser)" class="modal-overlay" @click.self="closeCreateModal">
      <div class="modal">
    ...
    <div v-if="showEditModal" class="modal-overlay" @click.self="closeEditModal">
      ...
      <div v-else-if="editingEquipe" class="modal modal-large">
        <h3>
          {{ canEditEquipeDetails(authUser) ? 'Modifier' : 'Gérer' }} l'équipe : {{ editingEquipe.nom }}
          <span class="role-indicator" :class="getRoleClass(authUser)">
            {{ getRoleLabel(authUser) }}
          </span>
        </h3>
        ...
        <div class="tabs">
          <button 
            v-if="canEditEquipeDetails(authUser)"
            class="tab" 
        ...
        <div v-if="canEditEquipeDetails(authUser)" v-show="editTab === 'infos'" class="tab-content">
        ...
        <div v-show="editTab === 'membres' || !canEditEquipeDetails(authUser)" class="tab-content">
