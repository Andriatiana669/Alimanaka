<template>
    ...
    <!-- MODAL DÉTAILS (voir membres) - VERSION SIMPLIFIÉE -->
...
const fetchCurrentUser = async () => {
  ...
  try {
    ...
    console.log('👤 Utilisateur courant:', currentUser.value)
  } catch (err) {
...
const openDetailsModal = async (equipe: Equipe) => {
  console.log('🔍 openDetailsModal appelé', equipe)
  console.log('🔍 Avant: showDetailsModal =', showDetailsModal.value)
  
  selectedEquipe.value = equipe
  showDetailsModal.value = true
  
  console.log('🔍 Après: showDetailsModal =', showDetailsModal.value)
  ...
  try {
    ...
    console.log('🔍 Membres chargés:', equipesStore.membresCurrentEquipe.length)
  } catch (err) {
...
const openEditModal = async (equipe: Equipe) => {
  console.log('✏️ openEditModal appelé', equipe)
