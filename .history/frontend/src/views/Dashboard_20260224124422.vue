...
const exportAllData = async () => {
  ...
  try {
    ...
    const exportData = {
      ...
      demandes: {
        enAttente: {
          conges: congesEnAttenteFiltres.value,
          ostie: ostieEnAttenteFiltres.value,
          permissions: permissionsEnAttenteFiltres.value,
          repos: reposEnAttenteFiltres.value,
          retards: retardsEnAttenteFiltres.value
        },
