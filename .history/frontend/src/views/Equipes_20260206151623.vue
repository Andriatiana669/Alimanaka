        ...
        <table v-else class="membres-table">
          ...
          <tbody>
            <tr v-for="membre in membres" :key="membre.id">
              ...
              <td v-if="isAdmin">
                <button class="btn-icon danger" @click="retirerMembre(membre)" title="Retirer de l'équipe">
            ...
            <table class="membres-table">
              ...
              <tbody>
                <tr v-for="membre in membres" :key="membre.id">
                  ...
                  <td>
                    <button class="btn-icon danger" @click="retirerMembre(membre)">
...
import EquipeNode from '@/components/EquipeNode.vue'
...
const retirerMembre = async (membre: User) => {
