      ...
      <div class="profile-details">
        ...
        <div class="detail-section">
          ...
          <div class="detail-grid">
            ...
            <div class="detail-item">
              <label>Pôle</label>
              <p>{{ currentUser?.pole_details?.nom || 'Non défini' }}</p>
            </div>
            <div class="detail-item">
              <label>Équipe</label>
...
const savePseudo = async () => {
  if (!isPseudoValid.value || !user.value) {
    console.log('Validation échouée:', { isValid: isPseudoValid.value, hasUser: !!user.value })
    return
  }
  ...
  try {
    let data: any // Temporairement any pour debug
    
    console.log('Format sélectionné:', pseudoForm.format)
    console.log('Valeur custom:', pseudoForm.customValue)
    ...
    pseudoError.value = err.response?.data?.error || err.message || 'Erreur inconnue'
  } finally {
