  ...
  <div class="equipes-page">
    ...
    <div v-if="selectedEquipe" class="equipe-details">
      <div class="details-header">
        ...
        <button v-if="true" class="btn-icon edit" @click="openEditModal(selectedEquipe)">
    ...
    <div v-if="showEditModal && editingEquipe" class="modal-overlay" @click.self="closeEditModal">
      <div class="modal modal-large">
        ...
        <div v-if="editTab === 'infos'" class="tab-content">
          <form @submit.prevent="saveEquipeInfos">
            ...
            <PoleSelect v-model="editForm.pole" label="Pôle" />
        ...
        <div v-if="editTab === 'membres'" class="tab-content">
          <!-- Ajouter un membre -->
      ...
      <div v-else-if="showEditModal" class="modal-overlay" style="background: red;">
        <div class="modal">
          <h3>ERREUR: editingEquipe est null</h3>
          <p>showEditModal: {{ showEditModal }}</p>
          <p>editingEquipe: {{ editingEquipe }}</p>
          <button @click="closeEditModal">Fermer</button>
        </div>
      </div>
...
const openEditModal = async (equipe: Equipe) => {
  ...
  console.log('Equipe reçue:', equipe)
  console.log('Equipe ID:', equipe?.id)
  
  editingEquipe.value = equipe
  console.log('editingEquipe set:', editingEquipe.value)
  ...
  // Charger les membres si pas déjà fait
  if (selectedEquipe.value?.id !== equipe.id) {
    console.log('Chargement des membres...')
    await selectEquipe(equipe)
  }
  
  // Charger tous les users pour les selects
