...
Maintenant voici mon "Equipes.vue" et j'ai quelques demandes à faire :
- Fais en sorte que chaque onglet arrive à tenir son état après actualisation ou autres actions.
- Le bouton "Toggle active/Inactive" n'apparait que si la personne est "super admin" ou "admin et manager" mais pas "admin et co-manager".
- Une utilisateur normale ne peux voir que le nom et les personnes dans le même équipes que lui.

Voici mon "Equipes.vue" et ne change pas le design et ne change rien d'autres à part que ce qui est demandé :
