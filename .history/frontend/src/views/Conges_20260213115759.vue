<template>
    ...
    <div class="page-header">
      <div class="header-left">
        ...
        <i class="bi bi-arrow-clockwise" :class="{ 'spin': refreshing }" style="font-size: 0.8rem; margin-left: 0.5rem;"></i>
      </div>
      </div>
...
// Resaka conges 
const refreshing = ref(false)  // ← Pour l'animation
...
const submitForm = async () => {
  ...
  try {
    ...
    // ← Rafraîchit UNIQUEMENT le solde (pas toute l'auth)
...
const refreshSolde = async () => {
  ...
  try {
    await authStore.refreshSolde()
    console.log('Solde rafraîchi:', authStore.soldeConge)
  } catch (err) {
