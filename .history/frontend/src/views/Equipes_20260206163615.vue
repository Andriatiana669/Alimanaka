<template>
  <div class="equipes-page">
    ...
    <div class="page-header">
      ...
      <span style="color:red">isAdmin: {{ canAdminEquipes }}</span>
...
const authUser = computed(() => useAuth().user.value)
...
const canAdminEquipes = computed(() => {
  const role = getUserRole(authUser.value)
