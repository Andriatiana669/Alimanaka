<template>
    ...
    <div class="page-header">
      <div class="header-left">
        <h1>Mes Congés</h1>
        <div v-if="authStore.user" class="solde-badge" @click="refreshSolde" style="cursor: pointer;" title="Cliquez pour rafraîchir">
          ...
          <i class="bi bi-arrow-clockwise" style="font-size: 0.8rem; margin-left: 0.5rem;"></i>
        </div>
      </div>
...
const refreshSolde = async () => {
  await authStore.checkAuth(true)  // ← Force le refresh !
  console.log('Solde rafraîchi:', authStore.user?.solde_conge_actuelle)
}
