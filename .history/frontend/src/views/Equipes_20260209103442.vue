<template>
  <div class="equipes-page">
    ...
    <!-- MODAL DÉTAILS - Version test simplifiée -->
...
">
  ...
  ">
    <h2 style="color: black;">TEST MODAL</h2>
    <p>selectedEquipe: {{ selectedEquipe?.nom }}</p>
    <p>membres: {{ membres.length }}</p>
    <button @click="showDetailsModal = false" style="padding: 10px 20px;">
      Fermer
    </button>
  </div>
</div>
