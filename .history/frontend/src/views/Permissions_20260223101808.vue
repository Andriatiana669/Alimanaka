    ...
    <div v-if="showDetailModal" class="modal-overlay" @click.self="closeDetailModal">
      <div class="modal modal-large">
        ...
        <div class="modal-body" v-if="selectedPermission">
          ...
          <div v-if="selectedPermission?.statut === 'approuve' && selectedPermission.valide_par_details" class="validation-box approved-box">

            <!-- DEBUG TEMPORAIRE -->
            <h5>✓ Permission approuvée</h5>
            
            <div v-if="selectedPermission.valide_par_details">
              <p><strong>Approuvé par:</strong> {{ selectedPermission.valide_par_details.display_name }} - {{ (selectedPermission.valide_par_details.username).toUpperCase() }}</p>
