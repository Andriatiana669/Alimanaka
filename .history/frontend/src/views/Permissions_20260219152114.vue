    ...
    <div v-if="showDetailModal" class="modal-overlay" @click.self="closeDetailModal">
      <div class="modal modal-large">
        ...
        <div class="modal-actions">
          ...
          <button 
            v-if="peutRetourner(selectedPermission) && (selectedPermission?.utilisateur === authStore.user?.id || canManageThisPermission(selectedPermission))"
            class="btn-success"
          ...
          <!-- Bouton annuler -->
          <button 
            v-if="peutAnnuler(selectedPermission) && (selectedPermission?.utilisateur === authStore.user?.id || canManageThisPermission(selectedPermission))"
            class="btn-warning"
      ...
      <div class="modal">
        ...
        <div class="modal-body">
          ...
          <div v-else-if="retourForm.heure_arrivee_reelle && minutesDepassement <= 0" class="preview-box success-box">
            <p>✅ Retour dans les temps ! Aucun rattrapage nécessaire.</p>
          </div>
