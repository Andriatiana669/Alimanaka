...
router.beforeEach(async (to, from, next) => {
  ...
  if (to.meta.disabled) {
    console.log('Route désactivée, redirection dashboard')
    next('/dashboard?error=route_disabled')
    return
  }
