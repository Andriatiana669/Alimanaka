...
class Equipe(models.Model):
    ...
    manager = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='equipes_gerees',  # Équipes où l'utilisateur est manager
...
class User(AbstractUser):
    ...
    date_joined = models.DateTimeField(auto_now_add=True, verbose_name="Date d'inscription", blank=True)
