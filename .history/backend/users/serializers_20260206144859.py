...
class EquipeTreeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Equipe
        fields = [
            'id', 'nom', 'manager', 'manager_details',  # AJOUTE manager_details
            'pole', 'pole_details',  # AJOUTE pole_details
            'membres_count',  # AJOUTE
            'sous_equipes', 'est_actif'
        ]
...
class UserListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = [
            'id', 'display_name', 'pseudo', 'pole_nom', 'equipe_nom',
