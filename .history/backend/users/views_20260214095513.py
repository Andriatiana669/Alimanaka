...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        if self.action == 'list':
            # Pour la liste, serializer différent selon le type d'utilisateur
            if self.request.user.is_staff:
                return UserSerializer  # Admin voit tout
            else:
                return UserListSerializer  # Non-admin voit une version limitée
        return UserProfileSerializer  # Pour /profile/, détails complets
