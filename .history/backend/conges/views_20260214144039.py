...
class CongeViewSet(viewsets.ModelViewSet):
    ...
    def calendrier(self, request):
        ...
        # Sérialisation des congés - CORRECTION INDENTATION ICI
        # Dans views.py - méthode calendrier

        # Dans views.py - méthode calendrier

        # Pour les congés, ajouter les heures selon le type
        for conge in conges_queryset.select_related('utilisateur'):
            ...
            event = {
                ...
                'allDay': False,  # ← CORRECTION : False pour avoir les heures
            ...
            if conge.date_fin > conge.date_debut:
                ...
                event['end'] = datetime.combine(day_after, heure_fin).isoformat()
            else:
