...
class CongeViewSet(viewsets.ModelViewSet):
    ...
    def calendrier(self, request):
        ...
        from datetime import time  # Import local pour éviter les conflits
        ...
        # CORRECTION : Inclure les congés qui chevauchent l'année
        # Un congé du 30/12/2025 au 05/01/2026 doit apparaitre en 2026
        from django.db.models import Q
        conges_queryset = Conge.objects.filter(
            Q(date_debut__year=annee) | Q(date_fin__year=annee),
        ...
        for conge in conges_queryset.select_related('utilisateur'):
            ...
            try:
                ...
                heure_fin = time(17, 0)   # 17:00 par défaut
            
            # Construire les datetime avec heures
            ...
            if conge.date_fin > conge.date_debut:
                # Pour multi-jours, on met la fin du dernier jour
