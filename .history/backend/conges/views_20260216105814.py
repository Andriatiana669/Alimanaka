...
class CongeViewSet(viewsets.ModelViewSet):
    ...
    def valider(self, request, pk=None):
        ...
        # CORRECTION : Vérifier que le solde n'a pas déjà été déduit
        # (car il est déjà déduit à la création dans ton code actuel)
        # Donc on ne redéduit PAS, on garde juste la déduction existante
