...
class CongeViewSet(viewsets.ModelViewSet):
    ...
    def annuler(self, request, pk=None):
        """Annuler une demande de congé et rembourser le solde UNIQUEMENT si déduit"""
        conge = self.get_object()
        ...
        # ✅ CORRECTION : Ne rembourser que si le congé était approuvé (solde déduit)
        if conge.statut == 'approuve' and conge.jours_deduits > 0:
            ...
            message = 'Congé en attente annulé (aucun remboursement)'
        ...
        return Response({
            'success': True,
            'message': message,
            'remboursement_effectue': conge.statut == 'approuve'
        })
