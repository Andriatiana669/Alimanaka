...
class CongeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'statut', 'statut_display', 'jours_deduits',
            'date_creation', 'date_modification',
            'valide_par', 'valide_par_details', 'date_validation',
            'refuse_par', 'refuse_par_details', 'date_refus', 'commentaire_refus'
        ]
        read_only_fields = ['jours_deduits', 'date_creation', 'date_modification', 'valide_par', 'date_validation', 'refuse_par', 'date_refus']
