...
class Permission(models.Model):
    ...
    def enregistrer_retour(self, heure_arrivee):
        ...
        self.statut = 'retourne'  # ← Toujours 'retourne' pour permettre les actions
        ...
        if arrivee_dt > max_dt:
            ...
            self.heures_restantes = Decimal('0')  # ← On met 0 mais on reste en 'retourne'
            # self.statut = 'approuve'  # ← SUPPRIMÉ : on reste en 'retourne'
