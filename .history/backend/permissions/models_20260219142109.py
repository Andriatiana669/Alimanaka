...
class Permission(models.Model):
    ...
    def enregistrer_retour(self, heure_arrivee):
        ...
        if arrivee_dt > max_dt:
            ...
            self.statut = 'termine'  # Pas de dépassement, terminé directement
    ...
    def transformer_en_conge(self, type_conge, user=None):
        ...
        conge = Conge.objects.create(
            ...
            statut='en_attente'  # Sera validé par le manager
        )
    ...
    def to_calendar_event(self):
        ...
        couleur = '#ff9800'  # Orange par défaut
        ...
        return {
            ...
            'peut_retourner': self.statut == 'planifie' and self.date <= date.today()
        }